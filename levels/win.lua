...
function scene:create( event )
	local sceneGroup = self.view
		...
		{
			label = "You've completed the first level, click to go back to main menu",
		...
		mainMenu.y = display.contentHeight - 900
		xapScore = display.newText({text = "Final score : "..xap.score, x = 1200, y = 600})
